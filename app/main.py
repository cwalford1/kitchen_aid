...
ROW_DATA = [
    ...
    ("Coffee", ("alert", [255 / 256, 165 / 256, 0, 1], "Running Low"),
    2,
    5,
    )
]
...
class MainApp(MDApp):
    def build(self):
        ...
        self.data_table = MDDataTable(
            use_pagination=True, check=True, column_data=COLUMN_DATA, row_data=ROW_DATA,sorted_on="item name",sorted_order="ASC",elevation=2
        )
